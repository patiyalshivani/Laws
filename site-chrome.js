(function () {
            ...
            <div class="bgl-main-header py-3">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        ...
                        <a class="bgl-about-link" href="about.html">About Us</a>
                    </div>
                </div>
            </div>
    ...
    const footer = `
        <footer class="hl-footer">
            <div class="container">
                <div class="row g-1">
                    <div class="col-md-3 hl-footer-brand">
                        <img src="./images/logo.png" alt="BG Laws" class="hl-footer-logo">
                        <p>We focus on practical advice, strong advocacy, and personal attention to every client.</p>
                        <a href="tel:6473029946"><i class="fas fa-phone"></i>647-302-9946</a>
    ...
    const menuGroups = {
        ...
        criminal: [
            ...
            ['Assault & Allegations', [['Assault Charges', 'assault-charges.html'], ['Sexual Assault', 'domestic-allegations.html'], ['Criminal Harassment and Uttering Threats Charges', 'uttering-threats.html']]],

(function () {
    ...
    const addSiteChrome = () => {
        ...
        if (window.__bglChromeAdded || document.querySelector('.service-site-header')) return;
        ...
        document.querySelector('.service-detail-shell')?.insertAdjacentHTML('afterbegin', `<header class="service-site-header"><div class="bgl-topbar py-2"><div class="container d-flex justify-content-between align-items-center"><div class="bgl-social"><a href="https://www.instagram.com/bg_laws" target="_blank" aria-label="Instagram"><i class="fab fa-instagram"></i></a></div><div class="bgl-quicklinks"><div id="google_translate_element" class="translate-widget"></div></div></div></div><div class="bgl-main-header py-3"><div class="container d-flex justify-content-between align-items-center"><a class="d-flex align-items-center text-decoration-none" href="index.html" aria-label="BG Laws home"><img src="./images/Bg.PNG" alt="BG Laws" class="bgl-logo-image"></a><div class="d-flex align-items-center gap-4"><div><div class="bgl-phone-label">For advice and support</div><a class="bgl-phone" href="tel:6473029946">647 302 9946</a></div><a class="bgl-contact-btn" href="contact.html">CONTACT US</a><a class="bgl-about-link" href="about.html">About Us</a></div></div></div><nav class="bgl-nav-wrap" aria-label="Service navigation"><div class="container"><ul class="bgl-service-nav"><li class="bgl-service-item"><a class="bgl-service-link" href="immigration.html">Immigration Law <i class="fas fa-caret-down"></i></a><div class="bgl-dropdown"></div></li><li class="bgl-service-item"><a class="bgl-service-link" href="criminal-law.html">Criminal Defence <i class="fas fa-caret-down"></i></a><div class="bgl-dropdown"></div></li><li class="bgl-service-item"><a class="bgl-service-link" href="real-estate.html">Real Estate Law <i class="fas fa-caret-down"></i></a><div class="bgl-dropdown"></div></li></ul></div></nav></header>`);
        document.querySelector('.service-detail-shell')?.insertAdjacentHTML('beforeend', `<footer class="hl-footer"><div class="container"><div class="row g-1"><div class="col-md-3 hl-footer-brand"><img src="./images/logo.png" alt="BG Laws" class="hl-footer-logo"><p>We focus on practical advice, strong advocacy, and personal attention to every client.</p><a href="tel:6473029946"><i class="fas fa-phone"></i>647-302-9946</a><a href="mailto:info@bglaws.ca"><i class="fas fa-envelope"></i>info@bglaws.ca</a><address><i class="fas fa-location-dot"></i><span>81 Zenway Blvd, Unit 2<br>Woodbridge, ON, L4H 0S5</span></address></div><div class="col-md-3"><h3>Quick Links</h3><a href="index.html">Home</a><a href="about.html">About Us</a><a href="contact.html">Contact</a></div><div class="col-md-3"><h3>Our Services</h3><a href="criminal-law.html">Criminal Law</a><a href="immigration.html">Immigration Law</a><a href="real-estate.html">Real Estate Law</a></div><div class="col-md-6 text-md-center"><h3>Hours</h3><div class="hours-list"><div><span>Mon</span><span>09:00 a.m. - 05:00 p.m.</span></div><div><span>Tue</span><span>09:00 a.m. - 05:00 p.m.</span></div><div><span>Wed</span><span>09:00 a.m. - 05:00 p.m.</span></div><div><span>Thu</span><span>09:00 a.m. - 05:00 p.m.</span></div><div><span>Fri</span><span>09:00 a.m. - 05:00 p.m.</span></div><div><span>Sat</span><span>By Appointment</span></div><div><span>Sun</span><span>Closed</span></div></div></div></div><div class="hl-footer-disclaimer"><h3>Disclaimer</h3><p>The information provided on this website is for general informational purposes only and should not be relied upon as legal advice. Viewing or using this website does not create a lawyer-client relationship with BG Laws.</p><p>No information contained on this website, or provided through emails, messages, or other correspondence from BG Laws, constitutes legal advice unless the advice is provided by a lawyer during a formal consultation or pursuant to a valid retainer agreement.</p><p>BG Laws disclaims liability for any loss or consequence arising from reliance on general information provided through this website or related communications.</p><p>You should obtain legal advice from a qualified lawyer regarding your specific circumstances before making any legal decision or taking any action based on information found on this website.</p></div><div class="hl-footer-bottom">Copyright &copy; 2026 BG Laws. All Rights Reserved.</div></div></footer>`);
    };
    ...
    const services = {
        ...
        "admissibility-hearings": ["Immigration Law / Litigation & Enforcement", "Admissibility Hearings & Detention Reviews", "Admissibility and detention proceedings can have major consequences for your ability to remain in Canada and require urgent, focused legal preparation.", "immigration"],
        ...
        "writ-of-mandamus": ["Immigration Law / Litigation & Enforcement", "Writ of Mandamus", "A writ of mandamus asks the Federal Court to compel an immigration authority to act when an application has been unreasonably delayed or a clear legal duty remains unfulfilled.", "immigration"],

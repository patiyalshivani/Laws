    ...
    const appendSourceContent = async (type, category, title, slug) => {
        ...
        try {
            ...
            if (slug === 'post-graduate-work-permits') {
                const panel = document.createElement('section');
                panel.className = 'service-source-content';
                panel.innerHTML = '<p class="service-source-label">Source-based service information</p><h2>Post-Graduate Work Permit (PGWP)</h2><h3><strong>What is the PGWP?</strong></h3><p>The Post-Graduation Work Permit is an open work permit that allows international graduates from eligible Canadian institutions to work for any employer in any industry across Canada. It offers valuable Canadian work experience and helps build eligibility for permanent residence through pathways like the Canadian Experience Class (CEC).</p><h3><strong>Eligibility Requirements</strong></h3><p>To qualify for a PGWP you must:</p><ul><li>Graduate from a program at a designated learning institution (DLI) and complete it full-time for at least 8 months (or equivalent)</li><li>Apply within 180 days after receiving your final transcript or completion letter</li><li>Be in valid status (study permit or visitor record) when applying</li><li>Meet new eligibility rules (for programs started November 1, 2024 or later) including language test requirement and field-of-study restrictions for college or non-university programs.</li></ul><h3><strong>Validity Period</strong></h3><ul><li>If your program was 8 months to less than 2 years, your PGWP may match the program length.</li><li>If your program is 2 years or more, you may qualify for up to a 3-year PGWP.</li><li>Multiple eligible programs may be combined to increase PGWP validity.</li></ul><h3><strong>Working After Graduation</strong></h3><p>If you apply before your study permit expires, you may work full-time while waiting for decision under implied status (Regulation 186(w)). If you wait until your permit expires without applying, you lose that right.</p><h3><strong>Documents You\'ll Need</strong></h3><ul><li>Completion letter or final transcript from the DLI confirming you finished your program.</li><li>Valid study permit or proof of status.</li><li>Passport, identification, application form, photos, and application fee.</li><li>Additional documents if your study program deviated from full-time status or had leave.</li></ul>';
                document.querySelector('.service-detail-content')?.appendChild(panel);
            }
        }
    };
